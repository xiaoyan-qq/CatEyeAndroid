...
public class Feature implements Cloneable {
    ...
    public long GetFieldAsInteger64(String name) {
        return ogrJNI.Feature_GetFieldAsInteger64__SWIG_1(swigCPtr, this, name);
    }
    ...
    public void GetFieldAsDateTime(String name, int[] pnYear, int[] pnMonth, int[] pnDay, int[] pnHour, int[] pnMinute, float[] pfSecond, int[] pnTZFlag) {
        ogrJNI.Feature_GetFieldAsDateTime__SWIG_1(swigCPtr, this, name, pnYear, pnMonth, pnDay, pnHour, pnMinute, pfSecond, pnTZFlag);
    }
    ...
    public byte[] GetFieldAsBinary(String name) {
        return ogrJNI.Feature_GetFieldAsBinary__SWIG_1(swigCPtr, this, name);
    }
