...
public class MainActivity extends SupportActivity implements TencentLocationListener {
    ...
    public enum LAYER_GROUP_ENUM {
        BASE_GRID_GROUP(0, "L0", "基础栅格图层", false),
        PROJ_GRID_GROUP(1, "L1", "项目栅格图层分组", false),
        BASE_VECTOR_GROUP(2, "L2", "基础矢量图层", true),
        PROJ_VECTOR_GROUP(3, "L3", "项目矢量图层分组", true),
        OTHER_GROUP(4, "L4", "其他图层分组", true),
        OBJECTS_3D_GROUP(5, "L5", "3D图层分组", true),
        OPERTOR_GROUP(6, "L6", "操作图层分组", true),
        LOCATION_GROUP(7, "L7", "当前位置分组", false);
